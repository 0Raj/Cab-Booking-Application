...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionMsg> noHandler(NoHandlerFoundException noHandler, WebRequest request) {
    ...
    public ResponseEntity<ExceptionMsg> myMANVExceptionHandler(
            MethodArgumentNotValidException methodArgumentNotValidException) {

        ExceptionMsg errorDetails = new ExceptionMsg(LocalDateTime.now(), HttpStatus.BAD_REQUEST.value(), "Validation Error",
